...
export default function PrivacyClient({ project }: { project: Project }) {
    const content = project.privacyContent;
            ...
            <main className="pt-24 px-6 pb-16">
                <div className="max-w-[720px] mx-auto">
                    ...
                    >
                        ...
                        <div>
                            <h1 className="text-[2rem] md:text-[2.5rem] font-bold tracking-tight">Privacy Policy</h1>
